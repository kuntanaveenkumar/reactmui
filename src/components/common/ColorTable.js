                        ...
                        if (columns.length === colIndex + 1) {
                            return (
                                <StyledTableCell key={colIndex} align="left">
                                    ...
                                    {displaylist.includes("radio") && (
                                        <>
                                            <FieldsContainer
                                                fields={[
                                                    {
                                                        controlId: 'select',
                                                        label: 'vehicles.select',
                                                        type: 'text',
                                                        name: 'select'
                                                    }
                                                ]}
...
const ColorTable = ({ rows, columns, handleDelete, handleView, handleSort, handleEdit, type, count, page, rowsPerPage, handlePage, handleRowsPerPage, displaylist, Order, handleAdd }) => (
